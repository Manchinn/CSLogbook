// filepath: c:\Users\chinn\CSLog\cslogbook\frontend\src.new\components\common\AdminUpload\AdminUpload.js
...
import './AdminUpload.css'; // Updated import path
...
const AdminUpload = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        '/api/upload-csv', // Updated API Path
        formData,
        {
          headers: {
  ...
  const handleDownloadTemplate = () => {
    window.location.href = '/template/download-template'; // Updated API Path
  };

  return (
    <div className="admin-upload-container"> {/* Use className from CSS file */}
