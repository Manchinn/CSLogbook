// filepath: c:\Users\chinn\CSLog\cslogbook\frontend\src.new\components\common\BackgroundParticles\BackgroundParticles.js
...
const BackgroundParticles = () => {
  ...
  const initParticles = () => {
    ...
    // const ctx = canvas.getContext('2d'); // ctx is initialized in animate() and drawConnections()
