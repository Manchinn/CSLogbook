...
// filepath: c:\Users\chinn\CSLog\cslogbook\frontend\src.new\components\layout\Sidebar\Sidebar.js
...
import { useStudentEligibility } from "../../../../context/StudentEligibilityContext";
...
const Sidebar = ({ inDrawer, onMenuClick }) => {
  ...
  const menuItems = useMemo(() => {
    ...
    return [
      ...
      {
        key: "/admin/dashboard", // Updated admin route
        icon: <HomeOutlined />,
        label: "หน้าแรก",
      },
        ...
        ? [
            {
              ...
              children: [
                {
                  key: "/admin/users/students", // Updated admin route
                  label: "นักศึกษา",
                },
                {
                  key: "/admin/users/teachers", // Updated admin route
                  label: "อาจารย์",
                },
                {
                  key: "/project-pairs",
            ...
            },
            {
              ...
              children: [
                {
                  key: "/admin/documents/internship", // Updated admin route
                  label: "เอกสารฝึกงาน",
                },
                {
                  key: "/admin/documents/project", // Updated admin route
            ...
            },
            {
              ...
              children: [
                {
                  key: "/admin/settings", // Updated admin route
                  label: "ภาพรวมการตั้งค่า",
                },
                {
                  key: "/admin/settings/curriculum", // Updated admin route
                  label: "หลักสูตรการศึกษา",
                },
                {
                  key: "/admin/settings/academic", // Updated admin route
                  label: "ปีการศึกษา/ภาคเรียน",
                },
                {
                  key: "/admin/settings/status", // Updated admin route
                  label: "สถานะนักศึกษา",
                }
              ],
            },
