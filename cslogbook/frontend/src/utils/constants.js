...
export const DATE_FORMAT_MEDIUM = "D MMMM YYYY"; // วัน เดือน ปี เช่น 22 มีนาคม 2568
export const DATE_FORMAT_LONG = "วันdddที่ D MMMM พ.ศ. YYYY"; // วันจันทร์ที่ 22 มีนาคม พ.ศ. 2568
export const DATE_TIME_FORMAT = "D MMMM YYYY เวลา HH:mm น."; // 22 มีนาคม 2568 เวลา 09:30 น.
