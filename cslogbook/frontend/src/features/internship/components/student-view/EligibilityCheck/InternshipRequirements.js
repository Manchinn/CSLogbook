...
const InternshipRequirements = () => {
  ...
  const internshipSteps = [
    ...
    {
      title: 'รับการประเมิน',
      description: 'รับการประเมินจากผู้ควบคุมงาน',
      icon: <RocketOutlined />
    }
  ];
  ...
  const documentRequirements = [
    ...
    'ข้อมูลติดต่อของสถานประกอบการและผู้ควบคุมงาน',
    'ใบลงเวลาการปฏิบัติงาน (ต้องบันทึกทุกวันในระบบ)',
    'รายงานสรุปผลการฝึกงาน (หลังฝึกงานเสร็จ)',
    'แบบประเมินผลการฝึกงาน (สำหรับผู้ควบคุมงาน)'
  ];

  // ข้อกำหนดการประเมินผล
  const evaluationRequirements = [
    'ประเมินโดยผู้ควบคุมงานผ่านแบบประเมินผลการฝึกงาน',
    'คะแนนเต็ม 100 คะแนน',
    'ต้องได้คะแนนไม่น้อยกว่า 70 คะแนน จึงจะถือว่าผ่าน (S)',
    'ต้องมีชั่วโมงฝึกงานไม่น้อยกว่า 240 ชั่วโมง',
    'ต้องบันทึกการปฏิบัติงานประจำวันอย่างสม่ำเสมอและครบถ้วน'
  ];
          ...
          description={
            <div>
              ...
              <ul>
                ...
                <li>หากมีปัญหาให้แจ้งผู้ควบคุมงานและอาจารย์ที่ปรึกษาทันที</li>
              </ul>
