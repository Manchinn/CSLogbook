...
import { phase2CardSteps } from 'features/project/components/student-view/Phase2Dashboard';
...
const Phase1Dashboard = () => {
  ...
  const handleAcknowledge = async () => {
    ...
    try {
      setAckLoading(true);
      const res = await (await import('features/project/services/projectService')).default.acknowledgeExamResult(activeProject.projectId);
      if (!res.success) {
