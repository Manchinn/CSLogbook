...
const MOCK_MILESTONES = {
  internship: {
    ...
    steps: [
      ...
      {
        id: 3,
        name: "รออนุมัติจากภาควิชา",
        status: "completed",
        date: "10/06/2024",
      },
      {
        id: 4,
        name: "รับหนังสือส่งตัว",
        status: "completed",
        date: "15/06/2024",
      },
      {
        id: 5,
        name: "รอหนังสือตอบรับ",
        status: "completed",
        date: "20/06/2024",
      },
      {
...
const MOCK_DEADLINES = [
  {
    id: 1,
    name: "วันสุดท้ายของยื่นสอบหัวข้อโครงงานพิเศษ",
    date: "19/07/2567",
    daysLeft: 45,
  },
  ...
  {
    id: 3,
    name: "วันสุดท้ายของการส่งเอกสารข้อเสนอ (บทที่ 1)",
    date: "30/08/2567",
    daysLeft: 87,
  },
  {
    id: 4,
    name: "วันสุดท้ายของการยื่นเอกสารขอทดสอบโครงงาน 30 วัน",
    date: "18/10/2567",
    daysLeft: 136,
  },
];
    ...
    return {
      ...
      dot:
        item.status === "in_progress" ? (
          <ClockCircleFilled style={{ fontSize: "16px" }} />
        ) : null,
      children: (
        <>
  ...
  return (
    <div className="timeline-settings">
      <Card className="setting-card">
        ...
        <Text type="secondary">
          ตัวอย่างการแสดงผลขั้นตอนและความก้าวหน้าของนักศึกษาในรูปแบบ Interactive
          Timeline
        </Text>
            ...
            >
              <Row gutter={16}>
                ...
                <Col span={6}>
                  ...
                  <Text>{student.credits}</Text>
                </Col>
                <Col span={6}>
                  <Text strong>หน่วยกิตวิชาเอก:</Text>{" "}
                  <Text>{student.majorCredits}</Text>
                </Col>
                <Col span={6}>
        ...
        >
          ...
          <Step
            ...
            description={
              student.projectEligible ? "พร้อมดำเนินการ" : "รอคุณสมบัติ"
            }
          ...
          <Col span={12}>
            <Card
              ...
              extra={
                student.internshipEligible ? (
                  <Tag color="success">
                    <UnlockOutlined /> มีสิทธิ์ดำเนินการ
                  </Tag>
                ) : (
                  <Tooltip title="ต้องมีหน่วยกิตสะสมมากกว่า 81 หน่วยกิต">
                    <Tag color="error">
                      <LockOutlined /> ยังไม่มีสิทธิ์
                    </Tag>
                  </Tooltip>
                )
              }
              ...
              title={
                <Space>
                  ...
                  {milestones.project.blocked && (
                    <Tag color="error">ไม่สามารถดำเนินการได้</Tag>
                  )}
                </Space>
              }
              extra={
                student.projectEligible ? (
                  ...
                  <Tooltip
                    title={`ต้องมีหน่วยกิตสะสมมากกว่า 95 หน่วยกิต และผ่านการฝึกงาน (${milestones.project.blockReason})`}
                  >
                    <Tag color="error">
                      <LockOutlined /> ยังไม่มีสิทธิ์
                    </Tag>
            ...
            >
              {milestones.project.blocked ? (
                <div style={{ padding: "20px 0", textAlign: "center" }}>
                  <LockOutlined
                    style={{ fontSize: 32, color: "#ff4d4f", marginBottom: 16 }}
                  />
                  <p>
                  ...
                  <p>
                    <Text type="secondary">
                      {milestones.project.blockReason}
                    </Text>
                  </p>
                </div>
              ) : (
            ...
            items={deadlines.map((deadline) => ({
              ...
              children: (
                <>
                  ...
                  <div>
                    <Text type="secondary">วันที่: {deadline.date}</Text>
                  </div>
                </>
              ),
            }))}
