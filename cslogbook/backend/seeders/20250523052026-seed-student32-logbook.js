 ...
 * เริ่มบันทึกตั้งแต่วันที่ 2025-05-16 ถึงวันที่ 2025-05-21
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      const startDate = dayjs('2025-05-16'); // วันที่เริ่มต้น (16 พฤษภาคม 2025)
      const endDate = dayjs('2025-05-21');   // วันที่สิ้นสุด (21 พฤษภาคม 2025)
