...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      const internshipId = 51; // รหัสการฝึกงาน
      // =====================================================================================

      const startDate = dayjs('2025-04-16'); // วันที่เริ่มต้น (16 เมษายน 2025)
      const endDate = dayjs('2025-07-02');   // วันที่สิ้นสุด (2 กรกฎาคม 2025)
