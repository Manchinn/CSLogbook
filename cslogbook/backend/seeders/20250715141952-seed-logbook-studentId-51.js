...
/**
 * Seeder สำหรับเพิ่มข้อมูล logbook ให้นักศึกษา ID 32
 * เริ่มบันทึกตั้งแต่วันที่ 2025-06-05 ถึงวันที่ 2025-06-06
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      // =====================================================================================
      const studentId = 51; // รหัสนักศึกษา
      const internshipId = 49; // รหัสการฝึกงาน
      // =====================================================================================

      const startDate = dayjs('2025-07-07'); // วันที่เริ่มต้น (7 กรกฎาคม 2025)
      const endDate = dayjs('2025-07-15');   // วันที่สิ้นสุด (15 กรกฎาคม 2025)
      ...
      console.error(`[Seeder] เกิดข้อผิดพลาดในการสร้างข้อมูล Logbook สำหรับนักศึกษา ID ${studentId}:`, error);
      if (error.original) {
